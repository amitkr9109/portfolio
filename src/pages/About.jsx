  ...
  return (
    <section data-section className="py-16 sm:py-20 md:py-28">
      <div className="container mx-auto px-4">
        ...
        <p className="mt-3 sm:mt-4 md:mt-6 text-sm sm:text-base md:text-lg text-gray-300 max-w-2xl">A short bio and our skills.</p>
        <div className="mt-10 sm:mt-12 md:mt-16">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold tracking-tight">Education</h2>
          <div className="mt-4 grid grid-cols-1">
            <div className="rounded-md border border-white/15 bg-white/5 backdrop-blur-sm p-4 sm:p-5 md:p-6">
