export default function SkillCard({ icon, title }) {
  return (
    <div
      className="group rounded-none border border-white/10 bg-white/5 text-white p-4 sm:p-5 md:p-6 backdrop-blur-sm shadow-[0_8px_30px_rgba(0,0,0,0.15)] transition-all duration-200 ease-out hover:border-white/20 hover:bg-white/10 hover:shadow-[0_12px_40px_rgba(0,0,0,0.25)] hover:-translate-y-0.5"
    >
